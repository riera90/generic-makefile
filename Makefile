...
# the folders are NOT generated by the makefile, please, create them
# we are working on fixin that problem.
# ./
#  ├main/
#  │ ├main.cc
#  │ └clases
...
clean:
	@echo cleaning.
	@rm -rf $(OUTPUT_DIR)**/*.out $(OBJ_DIR)**/*.o $(LIB_DIR)**/*.a
googletest : $(TESTS)
